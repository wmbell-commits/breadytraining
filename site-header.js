(function(){
  ...
  .br-mainbar{min-height:82px;display:flex;align-items:center;justify-content:space-between;gap:18px}
  .br-brand{display:flex;align-items:center;gap:11px;flex:0 0 auto;min-width:225px}
  .br-brand-symbol{display:block;width:60px;height:60px;object-fit:contain;flex:0 0 60px}
  .br-wordmark{display:flex;flex-direction:column;line-height:.9;white-space:nowrap}
  .br-wordmark-main{font-size:1.42rem;font-weight:950;letter-spacing:.025em;color:#fff}
  .br-wordmark-main .br-b{color:var(--br-yellow)}
  .br-wordmark-sub{margin-top:7px;font-size:.72rem;font-weight:900;letter-spacing:.30em;color:var(--br-yellow)}
  ...
  @media(max-width:1060px){.br-links{display:none}.br-brand{min-width:0}}
  @media(max-width:650px){
    .br-contactbar-inner,.br-mainbar{width:min(100% - 18px,1160px)}
    .br-contactbar-inner{justify-content:center;gap:12px;min-height:38px;font-size:.76rem;flex-wrap:wrap;padding:4px 0}
    .br-mainbar{min-height:70px;gap:7px}
    .br-brand{gap:7px}
    .br-brand-symbol{width:46px;height:46px;flex-basis:46px}
    .br-wordmark-main{font-size:1.05rem}.br-wordmark-sub{font-size:.56rem;letter-spacing:.23em;margin-top:5px}
    .br-cta{font-size:.69rem;padding:9px 8px}.br-menu summary{font-size:.69rem;padding:8px 8px}
    .br-menupanel{position:fixed;left:9px;right:9px;top:108px;width:auto}.br-navright{gap:6px}
  }
  @media(max-width:430px){
    .br-contactbar-inner{gap:8px}.br-contactbar a{font-size:.71rem}
    .br-brand-symbol{width:43px;height:43px;flex-basis:43px}
    .br-wordmark-main{font-size:.98rem}.br-wordmark-sub{font-size:.53rem;letter-spacing:.20em}
    .br-cta{display:none}
  }
  `;
